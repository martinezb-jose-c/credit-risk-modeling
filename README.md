...
- Processed data is stored in [GitHub] (https://github.com/martinezb-jose-c/credit-risk-modeling/releases/tag/v0.2-alpha) -> to get it, you can also run `02_feature_engineering.ipynb`.
